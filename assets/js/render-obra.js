...
import { setObraIdNaUrl } from './url-state.js';
...
export function calcDataFim(dataInicio, totalMeses) {
...
export function calcDataInicioProximo(dataInicio, totalMeses) {
    ...
    if (temCrono && o?.dataInicio) {
      ...
      if (dias !== null) {
        ...
        const txt = dias < 0
          ...
          : dias === 0 ? '\u{1F3C1} T\u00e9rmino hoje'
          : `\u{1F5D3}\uFE0F ${dias} dias restantes`;
